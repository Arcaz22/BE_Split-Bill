...
import com.portofolio.splitbill.repository.TokenRepository;
...
public class JwtServiceImpl implements JwtService {
    ...
    private String createToken(Map<String, Object> claims, UUID tokenId, UserDetails userDetails, long expiration, String secretKey) {
        return Jwts.builder()
                .setClaims(claims)
